...
export const CandyMint: FC = () => {
    ...
    const publicMint = useCallback(async () => {
        ...
        try {
            ...
            showNotification({ type: 'success', message: 'Mint successful!', txid: bs58.encode(signature) });
            getUserSOLBalance(wallet.publicKey, connection);

        } catch (error: any) {
            showNotification({ type: 'error', message: `Error minting: ${error?.message}` });
    ...
    const WLMint = useCallback(async () => {
        ...
        // Show loading notification
        showNotification({ type: 'loading', message: 'Whitelist minting in progress...' });
        ...
        try {
            ...
            if (!candyMachine) {
                ...
                showNotification({ type: 'error', message: 'Candy Machine not found!' });
                return;
            }
            ...
            if (!candyGuard) {
                ...
                showNotification({ type: 'error', message: 'Candy Guard is not initialized!' });
                return;
            }
            ...
            showNotification({ type: 'error', message: `An error occurred: ${error.message}` });
        }
    ...
    return (
        <div className="mintDetails">
            <h1 className="possum-title">MINT POSSUM</h1>
