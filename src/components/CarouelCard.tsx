...
const CarouelCard: React.FC<CarouelCardProps> = ({
  ...
  return (
    <article className="bg-[#fffbd2] font-grandstander border-[#212121] relative mx-auto flex aspect-[5/6.3] w-[240px] flex-col justify-between overflow-hidden rounded-[24px] border-[0.1em] shadow-[0.3em_0.3em_#212121] sm:w-[270px] sm:rounded-[29px] md:w-[300px] md:rounded-[32px] lg:w-[330px] lg:rounded-[36px] xl:w-[360px] xl:rounded-[40px] 2xl:w-[390px] 2xl:rounded-[44px]">
      {/* Name */}
